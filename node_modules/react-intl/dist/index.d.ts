...
export declare const FormattedDateParts: React.FC<import("./types").DateTimeFormatOptionsES2020 & CustomFormatConfig & {
    value: string | number | Date | undefined;
...
export declare const FormattedTimeParts: React.FC<import("./types").DateTimeFormatOptionsES2020 & CustomFormatConfig & {
    value: string | number | Date | undefined;
    children(val: Intl.DateTimeFormatPart[]): React.ReactElement<any, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)> | null) | (new (props: any) => React.Component<any, any, any>)> | null;
}>;
